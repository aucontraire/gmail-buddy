...
class OperationStatusTest {
    ...
    void testSuccessStatus() {
        assertThat(OperationStatus.SUCCESS.getDescription()).isEqualTo("Operation completed successfully");
    }

    @Test
    @DisplayName("PARTIAL_SUCCESS status has correct description")
    void testPartialSuccessStatus() {
        assertThat(OperationStatus.PARTIAL_SUCCESS.getDescription()).isEqualTo("Operation partially completed");
    }

    @Test
    @DisplayName("NO_RESULTS status has correct description")
    void testNoResultsStatus() {
        assertThat(OperationStatus.NO_RESULTS.getDescription()).isEqualTo("No items matched the criteria");
    }

    @Test
    @DisplayName("FAILURE status has correct description")
    void testFailureStatus() {
        assertThat(OperationStatus.FAILURE.getDescription()).isEqualTo("Operation failed");
    }
    ...
    void testValueOf() {
        assertThat(OperationStatus.valueOf("SUCCESS")).isEqualTo(OperationStatus.SUCCESS);
        assertThat(OperationStatus.valueOf("NO_RESULTS")).isEqualTo(OperationStatus.NO_RESULTS);
    }
    ...
    void testSwitchUsage() {
        String result =
                switch (OperationStatus.SUCCESS) {
