...
/**
 * Response DTO for batch mutation operations addressed by explicit message ID
 * (batch trash, batch untrash, batch modify labels).
 * Contains status information and details about successful and failed operations.
 *
 * <p>Structurally identical to {@link BulkDeleteResponse} but neutrally named,
 * since it is shared across non-delete batch operations (feature 005, research
 * Decision 3).</p>
 *
 * @since 1.0
 */
@Schema(description = "Result of a batch mutation operation addressed by message ID")
...
public class BatchOperationResponse {
    ...
    @Schema(description = "Number of successful operations", example = "9")
    private Integer successCount;

    @Schema(description = "Number of failed operations", example = "1")
    private Integer failureCount;

    @Schema(description = "List of message IDs for operations that succeeded")
    ...
    /**
     * Create a new builder for BatchOperationResponse
    ...
    /**
     * Builder for BatchOperationResponse following the builder pattern
     */
    public static class Builder {
        private final BatchOperationResponse response = new BatchOperationResponse();
        ...
        /**
         * Build the BatchOperationResponse instance
         * @return configured BatchOperationResponse
         */
        public BatchOperationResponse build() {
            return response;
        }
    }
