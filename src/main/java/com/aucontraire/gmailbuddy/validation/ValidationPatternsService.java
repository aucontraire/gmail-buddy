...
public class ValidationPatternsService {
    ...
    public ValidationPatternsService(GmailBuddyProperties properties) {
        ...
        this.dangerousPattern =
                Pattern.compile(properties.validation().gmailQuery().dangerousPattern(), Pattern.CASE_INSENSITIVE);
        this.validOperatorsPattern =
                Pattern.compile(properties.validation().gmailQuery().validOperatorsPattern(), Pattern.CASE_INSENSITIVE);
        this.emailPattern = Pattern.compile(properties.validation().email().pattern(), Pattern.CASE_INSENSITIVE);
    }
