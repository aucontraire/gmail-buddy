...
public record GmailBuddyProperties(
    ...
    public record GmailApi(
         ...
         */
        public record ServiceUnavailable(@Positive long defaultRetrySeconds) {
            // Default values are set in application.properties
        }
        ...
        public record MessageProcessing(@Valid @NotNull MimeTypes mimeTypes, @Valid @NotNull Labels labels) {
            ...
            public record Labels(@NotBlank String unread) {
                // Default values are set in application.properties
            }
        }
    ...
    public record OAuth2(@NotBlank String clientRegistrationId, @Valid @NotNull Token token) {
         ...
         */
        public record Token(@NotBlank String prefix) {
            // Default values are set in application.properties
        }
    }
     ...
     */
    public record Environment(@Valid @NotNull EnvFile envFile) {
        /**
