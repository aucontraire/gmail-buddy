...
public class FilterCriteriaMapper {
    ...
    public FilterCriteria toFilterCriteria(FilterCriteriaWithLabelsDTO criteria) {
        if (criteria == null) {
            return null;
        }

        FilterCriteria dto = new FilterCriteria();
    ...
    public FilterCriteriaDTO toFilterCriteria(FilterCriteria criteria) {
        if (criteria == null) {
            return null;
        }
