...
public class GmailController {
    ...
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Successfully retrieved latest messages",
                        content = @Content(schema = @Schema(implementation = MessageListResponse.class))),
                @ApiResponse(
                        responseCode = "401",
    ...
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Successfully filtered messages",
                        content = @Content(schema = @Schema(implementation = MessageListResponse.class))),
                @ApiResponse(
                        responseCode = "400",
    ...
    public ResponseEntity<MessageListResponse> listMessagesByFilterCriteria(
            ...
            @Parameter(description = "Page token for pagination") @RequestParam(required = false) String pageToken,
            @Parameter(description = "Maximum number of messages to return") @RequestParam(defaultValue = "50")
                    int limit) {
        ...
        MessageListResult result =
                gmailService.listMessagesByFilterCriteriaWithPagination(userId, filterCriteriaDTO, pageToken, limit);
     ...
     */
    @Operation(summary = "Delete a message", description = "Permanently deletes a single message by ID")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
    ...
    public ResponseEntity<DeleteOperationResult> deleteMessage(
            @Parameter(description = "The ID of the message to delete", required = true) @PathVariable @GmailMessageId
                    String messageId) {
        long startTime = System.currentTimeMillis();
        String userId = properties.gmailApi().defaultUserId();
        ...
        if (result.isSuccess()) {
            response = DeleteOperationResult.success(messageId)
                    .withMetadata(
                            ResponseMetadata.builder().durationMs(duration).build());
        } else {
    ...
    @ApiResponses(
            value = {
                ...
                @ApiResponse(
                        responseCode = "400",
                        description = "Invalid request - missing labels or invalid criteria",
                        content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
                @ApiResponse(
                        responseCode = "401",
                        description = "Unauthorized",
    ...
    @PostMapping(
            value = "/messages/filter/modifyLabels",
            consumes = MediaType.APPLICATION_JSON_VALUE,
            produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<LabelModificationResponse> modifyMessagesLabelsByFilter(
        ...
        List<String> labelsRemoved =
                dto.getLabelsToRemove() != null ? dto.getLabelsToRemove() : Collections.emptyList();

        LabelModificationResponse response =
                responseMapper.toLabelModificationResponse(result, labelsAdded, labelsRemoved);
    ...
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Batch trash operation completed (including partial or fully-failed)",
                        content = @Content(schema = @Schema(implementation = BatchOperationResponse.class))),
                @ApiResponse(
                        responseCode = "400",
                        description = "Invalid request - empty/oversized messageIds or ill-formed message ID",
                        content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
                @ApiResponse(
                        responseCode = "401",
                        description = "Unauthorized - invalid or missing authentication",
                ...
                @ApiResponse(
                        responseCode = "403",
                        description = "Forbidden - insufficient Gmail permissions",
                        content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
                @ApiResponse(
                        responseCode = "429",
                ...
                @ApiResponse(
                        responseCode = "503",
                        description = "Gmail API unavailable",
                        content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
            })
    @PostMapping(
            value = "/messages/batchTrash",
            consumes = MediaType.APPLICATION_JSON_VALUE,
            produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<BatchOperationResponse> batchTrashMessages(
            @Valid @RequestBody BatchMessageIdsRequest request, HttpServletRequest httpRequest) {
        ...
        httpRequest.setAttribute(
                ResponseHeaderFilter.ATTR_GMAIL_QUOTA_USED,
                response.getMetadata().getQuotaUsed());
    ...
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Batch untrash operation completed (including partial or fully-failed)",
                        content = @Content(schema = @Schema(implementation = BatchOperationResponse.class))),
                @ApiResponse(
                        responseCode = "400",
                        description = "Invalid request - empty/oversized messageIds or ill-formed message ID",
    ...
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Batch label-modify operation completed (including partial or fully-failed)",
                        content = @Content(schema = @Schema(implementation = BatchOperationResponse.class))),
                @ApiResponse(
                        responseCode = "400",
                        description =
                                "Invalid request - empty/oversized messageIds, both label lists empty, or ill-formed message/label ID",
                        content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
                @ApiResponse(
                        responseCode = "401",
                        description = "Unauthorized - invalid or missing authentication",
    ...
    @PostMapping(
            value = "/messages/batchModifyLabels",
            consumes = MediaType.APPLICATION_JSON_VALUE,
            produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<BatchOperationResponse> batchModifyLabelsByIds(
            @Valid @RequestBody BatchModifyLabelsByIdRequest request, HttpServletRequest httpRequest) {
    ...
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Message body retrieved successfully",
    ...
    public ResponseEntity<String> getMessageBody(
            @Parameter(description = "The ID of the message", required = true) @PathVariable @GmailMessageId
                    String messageId) {
        long startTime = System.currentTimeMillis();
        String userId = properties.gmailApi().defaultUserId();
     ...
     */
    @Operation(summary = "Mark message as read", description = "Marks a message as read by removing the UNREAD label")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
    ...
    @PutMapping(value = "/messages/{messageId}/read", produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<LabelModificationResponse> markMessageAsRead(
        ...
        LabelModificationResponse response =
                responseMapper.toLabelModificationResponse(result, Collections.emptyList(), labelsRemoved);
    ...
    @ApiResponses(
            value = {
                ...
                @ApiResponse(
                        responseCode = "400",
                        description = "Invalid request - validation failure or header-injection detected",
                        content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
                @ApiResponse(
                        responseCode = "401",
                        description = "Unauthorized - invalid or missing authentication",
                ...
                @ApiResponse(
                        responseCode = "413",
                        description =
                                "Payload too large - body alone exceeds 10 MB OR total assembled MIME (body + attachments) exceeds 25 MB",
                        content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
                @ApiResponse(
                        responseCode = "422",
                        description =
                                "Unprocessable entity - Gmail rejected one or more recipient addresses (type: /problems/invalid-recipient)",
                        content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
                @ApiResponse(
                        responseCode = "422",
                        description =
                                "Unprocessable entity - original message referenced by inReplyToMessageId not found in this account (type: /problems/original-message-not-found)",
                        content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
                @ApiResponse(
                        responseCode = "502",
                        description = "Gmail API error - draft creation failed",
                        content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
            })
    @PostMapping(
            value = "/drafts",
            consumes = MediaType.APPLICATION_JSON_VALUE,
            produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<DraftResponse> createDraft(@Valid @RequestBody SendMessageDTO dto) {
        ...
        logger.info(
                "Draft created: userId={}, draftId={}, recipientCount={}, to={}, cc={}, bcc={}, subject={}",
                userId,
                result.draftId(),
    ...
    @ApiResponses(
            value = {
                ...
                @ApiResponse(
                        responseCode = "404",
                        description = "Draft not found - already sent, discarded, or invalid draftId",
                        content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
                @ApiResponse(
                        responseCode = "413",
                        description =
                                "Payload too large - Gmail rejected the assembled MIME because it exceeds Gmail's maximum allowed size (35 MB raw)",
                        content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
                @ApiResponse(
                        responseCode = "422",
                        description = "Unprocessable entity - Gmail rejected one or more recipient addresses",
                        content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
                @ApiResponse(
                        responseCode = "429",
                        description = "Daily Gmail send limit reached - retry after 86400 seconds",
                        content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
                @ApiResponse(
                        responseCode = "502",
                        description = "Gmail API error - send failed",
                        content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
            })
    ...
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "201",
                        description = "Message sent successfully — new message resource created",
                        content = @Content(schema = @Schema(implementation = SendMessageResponse.class))),
                @ApiResponse(
                        responseCode = "400",
                        description = "Invalid request - validation failure or header-injection detected",
                ...
                @ApiResponse(
                        responseCode = "403",
                        description = "Forbidden - insufficient Gmail permissions or unverified send-as identity",
                        content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
                @ApiResponse(
                        responseCode = "413",
                        description =
    ...
    @PostMapping(
            ...
            consumes = MediaType.APPLICATION_JSON_VALUE,
            produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<SendMessageResponse> sendMessage(@Valid @RequestBody SendMessageDTO dto) {
        ...
        logger.info(
                "Message sent: userId={}, messageId={}, recipientCount={}, to={}, cc={}, bcc={}, subject={}",
                userId,
                result.messageId(),
                dto.to().size() + dto.cc().size() + dto.bcc().size(),
                dto.to(),
    ...
    @Operation(
            ...
            description =
                    "Returns a paginated list of draft summaries. Each item includes recipients, subject, snippet, "
    ...
    @ApiResponses(
            value = {
                ...
                @ApiResponse(
                        responseCode = "403",
                        description = "Forbidden - insufficient Gmail permissions (requires gmail.modify scope)",
                        content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
                @ApiResponse(
                        responseCode = "429",
                        description = "Rate limit exceeded",
    ...
    @ApiResponses(
            value = {
                ...
                @ApiResponse(
                        responseCode = "400",
                        description = "Invalid draft ID format",
                        content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
                @ApiResponse(
                        responseCode = "401",
                        description = "Unauthorized - invalid or missing authentication",
    ...
    public ResponseEntity<DraftDetailResponse> getDraft(
            @Parameter(description = "The Gmail-assigned draft identifier", required = true) @PathVariable @GmailDraftId
                    String draftId) {
    ...
    @ApiResponses(
            value = {
                ...
                @ApiResponse(
                        responseCode = "413",
                        description = "Payload too large - assembled MIME exceeds 25 MB",
                        content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
                @ApiResponse(
                        responseCode = "422",
                        description = "Unprocessable entity - invalid recipient or inReplyToMessageId not found",
                        content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
                @ApiResponse(
                        responseCode = "429",
                        description = "Rate limit exceeded",
                        ...
                        content =
                                @Content(
                                        schema =
                                                @Schema(
                                                        implementation =
                                                                com.aucontraire.gmailbuddy.dto.error.ErrorResponse
                                                                        .class))),
                @ApiResponse(
                        responseCode = "401",
                        description = "Unauthorized - invalid or missing authentication",
    ...
    public ResponseEntity<ThreadListResponse> listThreads(
            ...
            @Parameter(description = "Maximum number of threads to return (1–100, default 50)")
                    ...
                    @Max(100)
                    int limit,
            @Parameter(description = "Filter by sender email address") @RequestParam(required = false) @Size(max = 255)
                    String from,
            @Parameter(description = "Filter by recipient email address")
                    @RequestParam(required = false)
                    @Size(max = 255)
                    String to,
            @Parameter(description = "Filter by subject fragment") @RequestParam(required = false) @Size(max = 255)
                    String subject,
            @Parameter(description = "Raw Gmail search syntax") @RequestParam(required = false) @Size(max = 500)
                    String query,
            @Parameter(description = "Exclusion query") @RequestParam(required = false) @Size(max = 500)
                    String negatedQuery,
            @Parameter(description = "Filter for threads with attachments") @RequestParam(required = false)
    ...
    @ApiResponses(
            value = {
                ...
                @ApiResponse(
                        responseCode = "404",
                        description = "Thread not found - deleted or never existed",
                        content =
                                @Content(
                                        schema =
                                                @Schema(
    ...
    @ApiResponses(
            value = {
                ...
                @ApiResponse(
                        responseCode = "400",
                        description = "Invalid message ID format or unsupported format parameter",
                        content =
                                @Content(
                                        schema =
                                                @Schema(
                ...
                @ApiResponse(
                        responseCode = "404",
                        description = "Message not found - deleted or never existed",
                        content =
                                @Content(
                                        schema =
                                                @Schema(
    ...
    public ResponseEntity<MessageDetailResponse> getMessageDetail(
            ...
            @Parameter(
                            description =
                                    "Response format: 'full' (default, includes body) or 'metadata' (headers only, lower quota cost)")
                    @RequestParam(defaultValue = "full")
                    @Pattern(regexp = "(?i)full|metadata", message = "format must be 'full' or 'metadata'")
                    String format) {
    ...
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Successfully retrieved label detail",
                        content = @Content(schema = @Schema(implementation = LabelDetailResponse.class))),
                @ApiResponse(
                        responseCode = "400",
                        description = "Invalid label ID format (hyphens, slashes, or spaces rejected)",
                        content =
                                @Content(
                                        schema =
                                                @Schema(
    ...
    @ApiResponses(
            value = {
                ...
                @ApiResponse(
                        responseCode = "400",
                        description =
                                "Invalid request - blank/oversized name, control characters, or invalid visibility value",
                        content =
                                @Content(
                                        schema =
                                                @Schema(
                ...
                @ApiResponse(
                        responseCode = "409",
                        description = "A label with the requested name already exists",
                        content =
                                @Content(
                                        schema =
                                                @Schema(
    ...
    public ResponseEntity<LabelSummary> createLabel(
            @Valid @RequestBody CreateLabelRequest request, HttpServletRequest httpRequest) {
        String userId = properties.gmailApi().defaultUserId();
    ...
    @Operation(
            ...
            description =
                    "Returns the raw binary content of the specified attachment, decoded from Gmail's base64url encoding. "
    ...
    @ApiResponses(
            value = {
                ...
                @ApiResponse(
                        responseCode = "400",
                        description = "Invalid message ID or attachment ID format, or unsafe filename",
                        content =
                                @Content(
                                        schema =
                                                @Schema(
    ...
    public ResponseEntity<byte[]> getAttachment(
            ...
            @Parameter(
                            description =
                                    "Original filename for Content-Disposition header (optional; from listAttachments response)")
                    @RequestParam(required = false)
                    String filename,
        ...
        String effectiveMimeType = (mimeType != null && !mimeType.isBlank()) ? mimeType : "application/octet-stream";
        String effectiveFilename = (filename != null && !filename.isBlank()) ? filename : "attachment";
        ...
        try {
            ...
            throw new com.aucontraire.gmailbuddy.exception.GmailApiException(
                    "Failed to materialise attachment bytes for messageId=" + messageId + ", attachmentId="
                            + attachmentId,
                    e);
        }
        ...
        try {
            ...
            throw new ValidationException("mimeType query parameter is not a valid MIME type: " + effectiveMimeType
        ...
        return ResponseEntity.ok().headers(headers).body(decoded);
    }
    ...
    @Operation(
            ...
            description =
                    "Returns the current OAuth2 access token for debugging purposes. Use this to get a Bearer token for Postman.")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
    ...
    private List<MessageSummary> convertToSummaries(List<Message> messages) {
        ...
        return messages.stream().map(MessageSummary::from).collect(Collectors.toList());
    }
}
